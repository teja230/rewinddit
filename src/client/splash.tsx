...
const HowItWorks = () => (
  <div className="flex items-center justify-center gap-6 mt-2">
    ...
    <div className="flex flex-col items-center gap-1.5">
      ...
      <span className="text-xs text-gray-500 font-medium">Guess</span>
    </div>
    <div className="text-gray-300 text-lg">{'\u2192'}</div>
    <div className="flex flex-col items-center gap-1.5">
...
export const Splash = () => {
  return (
    <div className="flex relative flex-col justify-center items-center min-h-screen gap-5 bg-gradient-to-b from-gray-50 to-orange-50/30">
      {/* Logo / Brand */}
      ...
      {/* Footer */}
      <p className="text-xs text-gray-300 mt-2">New puzzle every day at midnight UTC</p>
    </div>
  );
};
